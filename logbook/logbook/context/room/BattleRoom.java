...
import logbook.context.dto.battle.daymidnight.CombinebattleResultDto;
...
public class BattleRoom extends Room {
	...
	public void doBattleShipdeck(Data data, JsonValue json) {
		try {
			...
			GlobalContext.getBattlelist().add(new InfoBattleShipDeckDto());
		} catch (Exception e) {
	...
	public void doCombinebattleResult(Data data, JsonValue json) {
		try {
			GlobalContext.getBattlelist().add(new CombinebattleResultDto(data, (JsonObject) json));
		} catch (Exception e) {
